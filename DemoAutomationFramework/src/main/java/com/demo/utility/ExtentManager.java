...
public class ExtentManager extends WebDriverHelper
{
	...
	public static void verificationStep(String result,String stepName) throws IOException
	{
		...
		if(result.toLowerCase().trim().equals("fail"))
		{
			...
			{
				//childTest.log(Status.FAIL, MarkupHelper.createLabel(stepName, ExtentColor.RED));
