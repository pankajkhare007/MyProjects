...
public class ExcelManager {
    ...
    static int rowNum;
    private static final String dataFileDir = System.getProperty("user.dir") + "\\src\\main\\resources\\Data\\";

    private static void readExcelFile(String workBook, String sheetName) {
        String filePath = dataFileDir + workBook;
    ...
    private static int getHeaderColNumber(String header) {
        int colNumber = 0;
    ...
    public static int getRowNumber(String wBook, String sheetName, String condition) {
    ...
    public static int getRowIndex(String wBook, String sheetName, String condition) {
